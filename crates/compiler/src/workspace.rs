...
/// the compiler remains independent of `arc`. GDS imports live here because
/// they affect both static analysis (synthetic cell declarations) and dynamic
/// execution (loading the referenced geometry).
